...
@EnableJpaRepositories(basePackages = {
    "com.viloveul.module.common.data.repository"
})
...
public class TestConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(ApplicationEventPublisher publisher) {
        ...
        factory.setPackagesToScan(
            "com.viloveul.module.common.data.entity"
        );
    ...
    public DataSourceInitializer dataSourceInitializer() {
        ...
        databasePopulator.addScript(new ClassPathResource("/migrations/V1_0_0__00100ALLSCHCMN.sql"));
